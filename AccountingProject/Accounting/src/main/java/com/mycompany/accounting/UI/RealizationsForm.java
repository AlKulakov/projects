...
import com.mycompany.accounting.MySqlOperations.RealizationSqlQuery;
...
public class RealizationsForm extends javax.swing.JFrame {

    /**
     * Creates new form RealizationsFrame
     */
    RealizationSqlQuery realizationsQuery = new RealizationSqlQuery();
    public RealizationsForm() {
        initComponents();
        realizationsQuery.fillStuffCombobox(stuffComboBox, categoryComboBox.getSelectedItem().toString());
        realizationsQuery.fillRealizationsTable(realizationsTable);
    }
    ...
    private void initComponents() {
        ...
        realizationsScrollPane = new javax.swing.JScrollPane();
        realizationsTable = new javax.swing.JTable();
        ...
        realizationsScrollPane.setBackground(new java.awt.Color(255, 255, 255));
        realizationsScrollPane.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        realizationsScrollPane.setOpaque(false);

        realizationsTable.setAutoCreateRowSorter(true);
        realizationsTable.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        realizationsTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID", "Имя предмета", "Количество", "Дата реализации"
            }
        ));
        realizationsTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                realizationsTableMouseClicked(evt);
            }
        });
        realizationsScrollPane.setViewportView(realizationsTable);
        ...
        innerPanelLayout.setHorizontalGroup(
            ...
            .addGroup(innerPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(innerPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(innerPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(innerPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(categoryComboBox, 0, 156, Short.MAX_VALUE)))))
                ...
                .addGroup(innerPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(innerPanelLayout.createSequentialGroup()
                        .addGap(30, 30, 30)
                        .addComponent(realizationsScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, 699, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(12, 12, 12))
        ...
        innerPanelLayout.setVerticalGroup(
            ...
            .addGroup(innerPanelLayout.createSequentialGroup()
                ...
                .addGroup(innerPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(realizationsScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
                .addGap(18, 18, 18)
    ...
    private void realizationsTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_realizationsTableMouseClicked
        DefaultTableModel model = (DefaultTableModel) realizationsTable.getModel();
        int rowIndex = realizationsTable.getSelectedRow();
        ...
        try {
            ...
            Logger.getLogger(RealizationsForm.class.getName()).log(Level.SEVERE, null, ex);
        }
         
    }//GEN-LAST:event_realizationsTableMouseClicked
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        if(realizationsQuery.addRealization(stuffName, amount, date)){
            resultLabel.setText("Реализация добавлена!");
            clearFields();
            refreshTable();
        }
        else {
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        ...
        if(dataConfirm(amount))
        if(realizationsQuery.editRealization(id, stuffName, amount, date)){
            resultLabel.setText("Реализация изменена!");
            clearFields();
            refreshTable();
        }
        else {
    ...
    private void removeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeButtonActionPerformed
        ...
        if(realizationsQuery.removeRealization(id)){
            resultLabel.setText("Реализация удалена!");
            clearFields();
            refreshTable();
        }
        else {
    ...
    private void categoryComboBoxItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_categoryComboBoxItemStateChanged
        ...
        realizationsQuery.fillStuffCombobox(stuffComboBox, categoryComboBox.getSelectedItem().toString());        // TODO add your handling code here:
    ...
    private void refreshTable(){
        realizationsTable.setModel(new DefaultTableModel(null, new Object[]{"ID","Имя предмета", "Количество", "Дата поставки"}));
        realizationsQuery.fillRealizationsTable(realizationsTable);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RealizationsForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RealizationsForm().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JScrollPane realizationsScrollPane;
    private javax.swing.JTable realizationsTable;
